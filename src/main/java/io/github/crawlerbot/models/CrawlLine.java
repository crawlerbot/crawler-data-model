...
import io.github.crawlerbot.domain.enumeration.BrowserHost;
import io.github.crawlerbot.domain.enumeration.BrowserName;
import io.github.crawlerbot.models.crawl.Channel;
...
public class CrawlLine implements Serializable {
    ...
    public CrawlLine updateData(List<HashMap<String, List<String>>> newData) {
